...
export default function Bedroom() {
  const { data: products, isLoading } = useProductsByCategory(Category.bedroom);
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'url(/assets/generated/bedroom-banner.dim_1200x400.png)' }}
        >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 text-left">
          ...
          <p className="text-lg text-muted-foreground font-light max-w-2xl">
            Design your perfect sanctuary with our beds, wardrobes, and side tables
          </p>
        </div>
      </section>
