...
export class Backend implements backendInterface {
    ...
    async getFavoriteProducts(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFavoriteProducts();
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "bedroom" in value ? Category.bedroom : "office" in value ? Category.office : "livingRoom" in value ? Category.livingRoom : "dining" in value ? Category.dining : value;
}
...
function to_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.bedroom ? {
        bedroom: null
    } : value == Category.office ? {
        office: null
    } : value == Category.livingRoom ? {
        livingRoom: null
